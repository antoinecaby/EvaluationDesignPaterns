...
On va utiliser un Strategie car il va falloir envoyer des notifications sur 3 canaux différents (email, log et Discord), mais l'envoiue de ces notifications se fait d'une façon différente + un Factory pour la création des notifications
